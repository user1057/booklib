...
@RestController
@RequestMapping("/api/booklib-kafka")
public class BooklibKafkaResource {

    private final Logger log = LoggerFactory.getLogger(BooklibKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public BooklibKafkaResource(KafkaProperties kafkaProperties) {
