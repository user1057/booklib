...
import { PageContentDeleteDialogComponent } from 'app/entities/page-content/page-content-delete-dialog.component';
  ...
  describe('PageContent Management Delete Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [PageContentDeleteDialogComponent]
      })
